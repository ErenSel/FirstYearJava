...
public class PersonelSayfasi extends JFrame {
	...
	public PersonelSayfasi() {
		...
		JLabel lblNewLabel = new JLabel("Hosgeldiniz, Sayın Çalışan");
		...
		JButton btnNewButton_1_3 = new JButton("Para Transferi");
